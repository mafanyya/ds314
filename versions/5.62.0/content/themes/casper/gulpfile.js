...
const  cssWatcher = () => watch('assets/css/**', { ignoreInitial: true }, css);
const jsWatcher = () => watch('assets/js/**', { ignoreInitial: true }, js);
const hbsWatcher = () => watch(['*.hbs', 'partials/**/*.hbs'], { ignoreInitial: true }, hbs);
